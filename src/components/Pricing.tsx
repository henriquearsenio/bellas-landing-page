          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <div className="text-5xl font-bold text-card-foreground mb-2">{plan.price}</div> {/* Preço principal */}
                {plan.period && (
                  <p className="text-muted-foreground text-sm leading-relaxed">{plan.period}</p> {/* Período abaixo do preço */}
                )}
              </div>
